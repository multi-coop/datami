<template>
  <div
    :class="`GitributeCardBlockContent-${position} gitribute-component ${classes[position].content}`">
    <!-- LABEL IF EDIT MODE -->
    <p
...
export default {
  name: 'GitributeCardBlockContent',
  components: {
    // PreviewCell,
    EditCell
  },
  ...
  // beforeMount () {
  //   console.log('\nC > GitributeCardBlockContent > beforeMount > this.itemId :', this.itemId)
  //   console.log('C > GitributeCardBlockContent > beforeMount > this.position :', this.position)
  //   console.log('C > GitributeCardBlockContent > beforeMount > this.fieldLabel :', this.fieldLabel)
  //   console.log('C > GitributeCardBlockContent > beforeMount > this.field :', this.field)
  //   console.log('C > GitributeCardBlockContent > beforeMount > this.itemValue :', this.itemValue)
  // },
  methods: {
    // applyTemplate (text) {
    //   // prepare regex
    ...
    //   console.log('\nC > GitributeCardBlockContent > applyTemplate > textArr :', textArr)
    //   textArr = textArr.map(str => {
    //     let strClean
    //     if (str.startsWith(fieldStart)) {
    //       const fieldName = str.replace(fieldStart, '').replace(fieldEnd, '').trim()
    //       console.log('C > GitributeCardBlockContent > applyTemplate > fieldName :', fieldName)
    //       strClean = str
    //     } else {
    //       strClean = str
    //     }
    ...
    // toggleDetail () {
    //   console.log('C > GitributeCardBlockContent > toggleDetail > this.position :', this.position)
