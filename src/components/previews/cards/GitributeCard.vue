<template>
  <div
    v-if="item"
    :class="`GitributeCard gitribute-component card ${isHovered || showDetail ? 'hover-effect' : '' }`"
...
import GitributeCardBlockImage from '@/components/previews/cards/GitributeCardBlockImage'
import GitributeCardBlockContent from '@/components/previews/cards/GitributeCardBlockContent'
import GitributeCardBlockTags from '@/components/previews/cards/GitributeCardBlockTags'
import GitributeCardBlockLinks from '@/components/previews/cards/GitributeCardBlockLinks'

import GitributeMiniMap from '@/components/previews/maps/GitributeMiniMap'
...
export default {
  ...
  methods: {
    ...
    getTemplatedValues (field) {
      // console.log('\nC > GitributeCard > applyTemplate > field :', field)
      ...
      let textArr = text
        ...
        .map(str => {
          ...
          if (str.startsWith(fieldStart)) {
            ...
            // console.log('\nC > GitributeCard > applyTemplate > fieldName :', fieldName)
            const fieldObj = this.fields.find(f => f.name === fieldName)
            // console.log('C > GitributeCard > applyTemplate > fieldObj :', fieldObj)
    ...
    // },
    toggleDetail (event) {
      // console.log('\nC > GitributeCard > toggleDetail > event :', event)
      // console.log('C > GitributeCard > toggleDetail > this.fieldMapping :', this.fieldMapping)
      // console.log('C > GitributeCard > toggleDetail > this.showDetail :', this.showDetail)
      const payload = {
        isMini: this.isMini,
