<template>
  <div
    class="GitributeMap gitribute-component"
...
import GitributeMapLayers from '@/components/previews/maps/GitributeMapLayers'
import GitributeMapLegend from '@/components/previews/maps/GitributeMapLegend'

import PopupContent from '@/components/previews/maps/GitributeMapPopup'
...
export default {
  ...
  computed: {
    ...
    itemsForMap () {
      // console.log('\nC > GitributeMap > itemsForMap ...')
      if (this.items) {
        // console.log('C > GitributeMap > itemsForMap > this.items ... not empty ...')
        // console.log('C > GitributeMap > itemsForMap > this.items : ', this.items)
        const geoItems = this.items.filter(item => this.checkIfItemHasLatLng(item))
        return geoItems
      } else {
        // console.log('C > GitributeMap > itemsForMap > this.items ... empty or undefined ...')
    ...
    getBbox () {
      ...
      bbox = bbox || emptyBox
      // console.log('C > GitributeMap > getBbox > bbox : ', bbox)
      return bbox
    },
    getViewBbox () {
      const canvas = this.map && this.map.getCanvasContainer()
      // console.log('C > GitributeMap > getViewBbox > canvas : ', canvas)
      const rect = canvas && canvas.getBoundingClientRect()
      // console.log('C > GitributeMap > getViewBbox > rect : ', rect)
      ...
      // console.log('C > GitributeMap > getViewBbox > currrentViewBbox : ', currrentViewBbox
      return currrentViewBbox
    },
    currentChoroSource () {
      // console.log("\nC > GitributeMap > currentChoroSource ...")
      // console.log("C > GitributeMap > currentChoroSource > this.choroplethGeoJSONS : ", this.choroplethGeoJSONS )
      const choroSource = this.choroplethGeoJSONS.find(c => c.min_zoom < this.getZoom && this.getZoom < c.max_zoom)
      // console.log("C > GitributeMap > currentChoroSource > choroSource : ", choroSource )
      return choroSource
    },
    getCorrespondingChoroConfigs () {
      ...
      // console.log('C > GitributeMap > getCorrespondingChoroConfigs > mapChoroConfigs : ', mapChoroConfigs)
  ...
  watch: {
    ...
    async items () {
      if (this.map && !this.isClusterSet && this.itemsForMap) {
        // console.log('\nC > GitributeMap > watch > items > createGeoJsonDataPoints ( from geoJson.js ) ...')
        this.geoJson = createGeoJsonDataPoints(this.itemsForMap, this.fieldLat, this.fieldLong)
        // console.log('C > GitributeMap > watch - items - this.geoJson : ', this.geoJson)
        await this.createMapItems(this.geoJson)
      }

      if (this.map && this.isClusterSet) {
        // console.log('\nC > GitributeMap > watch > items > updateSourceData ...')
        ...
        // console.log('\nC > GitributeMap > watch > items > else (no map yet) ...')
      }
    },
    activeFilterTags (next) {
      // console.log('\nC > GitributeMap > watch > activeFilterTags > next:', next)
      this.getMapHeightTop()
    },
    userFullscreen (next) {
      // console.log('\nC > GitributeMap > watch > userFullscreen > next:', next)
      if (next) {
        // console.log('C > GitributeMap > watch > activeFilterTags >  screen.height:', screen.height)
        // console.log('C > GitributeMap > watch > activeFilterTags > this.mapHeightTop:', this.mapHeightTop)
  ...
  beforeMount () {
    // console.log('\nC > GitributeMap > beforeMount > this.mapSettings : ', this.mapSettings)
    // console.log('C > GitributeMap > beforeMount > this.fields : ', this.fields)
  ...
  mounted () {
    // console.log('\nC > GitributeMap > mounted > this.mapId : ', this.mapId)
    this.initializeMap()
  },
  methods: {
    getDocWidth () {
      const docWidth = document.body.clientWidth
      // console.log('\nC > GitributeMap > getDocWidth > docWidth : ', docWidth)
      let cardMiniWidth
      let cardDetailWidth
      if (docWidth <= 768) {
        cardMiniWidth = '75%'
      ...
      // console.log('C > GitributeMap > getDocWidth > cardMiniWidth : ', cardMiniWidth)
      // console.log('C > GitributeMap > getDocWidth > cardDetailWidth : ', cardDetailWidth)
    ...
    getMapHeightTop () {
      ...
      if (this.mapOnTop) {
        ...
        if (fileNavbarElem && sortFiltersElem && editCsvElem) {
          ...
          // console.log('\nC > GitributeMap > mapHeightTop > fileNavbarElem : ', fileNavbarElem)
          // console.log('C > GitributeMap > mapHeightTop > h1 : ', h1)
          // console.log('C > GitributeMap > mapHeightTop > sortFiltersElem : ', sortFiltersElem)
          // console.log('C > GitributeMap > mapHeightTop > h2 : ', h2)
          // console.log('C > GitributeMap > mapHeightTop > editCsvElem : ', editCsvElem)
          // console.log('C > GitributeMap > mapHeightTop > h3 : ', h3)
          // const adjusting = (this.activeFilterTags && this.activeFilterTags.length) ? 12 : 5
          const adjusting = 4
          height = h1 + h2 + h3 + adjusting
        }
        // console.log('C > GitributeMap > mapHeightTop > height : ', height)
      }
    ...
    initializeMap () {
      ...
      // console.log('C > GitributeMap > mounted > map : ', map)
      map.on('load', async () => {
    ...
    async createMapItems (geoJson) {
      // console.log('\nC > GitributeMap > createMapItems ...')
      const mapOptions = this.mapOptions

      // adding reactive source
      // console.log('C > GitributeMap > createMapItems > geoJson :', geoJson)
      // console.log('C > GitributeMap > createMapItems > this.map :', this.map)
    ...
    updateSourceData (itemsForMap) {
      this.log && console.log('\nC > GitributeMap > updateSourceData ...')
      // console.log("C > GitributeMap > updateSourceData > this.map :", this.map)
      // console.log("C > GitributeMap > updateSourceData > itemsForMap :", itemsForMap)
      ...
      if (itemsForMap) {
        ...
        // console.log('\nC > GitributeMap > updateSourceData > createGeoJsonDataPoints ( from geoJson.js ) ...')
        ...
        // console.log('C > GitributeMap > updateSourceData > allPointsSourceId : ', allPointsSourceId)
        this.map.getSource(allPointsSourceId).setData(geoJson)

        // console.log('C > GitributeMap > updateSourceData > geoJsonSourceId : ', geoJsonSourceId)
    ...
    async createAddGeoJsonSource (geoJson) {
      // console.log('\nC > GitributeMap > createAddGeoJsonSource > geoJson :', geoJson)

      const mapLayersOptions = this.mapLayersOptions
      // console.log('C > GitributeMap > createAddGeoJsonSource > mapLayersOptions :', mapLayersOptions)
      ...
      if (mapLayersOptions.all_points_layer && mapLayersOptions.all_points_layer.is_activated) {
        ...
        // console.log('C > GitributeMap > createAddGeoJsonSource > allPointsSource :', allPointsSource)
      ...
      if (mapLayersOptions.cluster_circles_layer && mapLayersOptions.cluster_circles_layer.is_activated) {
        ...
        // console.log('C > GitributeMap > createAddGeoJsonSource > geoJsonSource :', geoJsonSource)
    ...
    async createChoroplethSource (isUpdate = false) {
      // console.log('\nC > GitributeMap > createChoroplethSource > isUpdate : ', isUpdate)

      const mapLayersOptions = this.mapLayersOptions
      // console.log('C > GitributeMap > createChoroplethSource > mapLayersOptions :', mapLayersOptions)

      // - - - - - - - - - - - - - - - - //
      // SOURCE - CHOROPLETH //
      if (mapLayersOptions.choropleth_layer && mapLayersOptions.choropleth_layer.is_activated) {
        // console.log('C > GitributeMap > createChoroplethSource > mapLayersOptions.choropleth_layer :', mapLayersOptions.choropleth_layer)
        this.showLoader = true
        ...
        for (const source of choroplethConfigOptions.sources) {
          if (source.is_activated) {
            ...
            // console.log('\nC > GitributeMap > createChoroplethSource > source : ', source)
            // console.log('C > GitributeMap > createChoroplethSource > source.source_id : ', source.source_id)
            ...
            if (source.need_aggregation && !isUpdate) {
              ...
              // console.log('C > GitributeMap > createChoroplethSource > source.need_aggregation && !isUpdate ')
            ...
            if (source.need_aggregation && !source.update_src_from_previous_source) {
              // console.log('C > GitributeMap > createChoroplethSource > source.need_aggregation + isUpdate : ', isUpdate)
              const choroRefIdex = this.choroplethGeoJSONS.findIndex(c => c.source_id === source.source_id)

              if (!isUpdate) {
                // console.log('C > GitributeMap > createAddGeoJsonSource > source.source_url :', source.source_url)
                const choroSource = await getData(source.source_url, 'createAddGeoJsonSource')
                // console.log('C > GitributeMap > createAddGeoJsonSource > choroSource :', choroSource)
            ...
            // if ( !source.need_aggregation || !isUpdate ) {
            if (!source.need_aggregation && !isUpdate) {
              // console.log('C > GitributeMap > createChoroplethSource > !source.need_aggregation ')
    ...
    getRenderedChoroFeatures (layerId) {
      // console.log('\nC > GitributeMap > getRenderedFeatures... ')
      ...
      // console.log('C > GitributeMap > getRenderedFeatures > renderedFeatures : ', renderedFeatures)
    ...
    async updateChoroSourceByZoom (choroSourceConfig, featuresArray = undefined) {
      ...
      // console.log('\nC > GitributeMap > updateChoroSourceByZoom > choroSourceConfig : ', choroSourceConfig)
      const center = this.getCenter

      const choroRefIdex = this.chroplethGeoJSONS.findIndex(c => c.source_id === choroSourceConfig.source_id)
      // console.log('\nC > GitributeMap > updateChoroSourceByZoom > choroRefIdex : ', choroRefIdex)
      ...
      for (const update of choroSourceConfig.update_src_options) {
        ...
        if (!featuresArray) {
          ...
          // console.log('C > GitributeMap > updateChoroSourceByZoom > renderredCenters : ', renderredCenters)

          if (update.upper_load_feat === 'only_center') {
            const viewCenter = turf.point([center.lng, center.lat])
            // console.log('\nC > GitributeMap > updateChoroSourceByZoom > viewCenter : ', viewCenter)

            const nearest = turf.nearestPoint(viewCenter, renderredCenters)
            // console.log('C > GitributeMap > updateChoroSourceByZoom > nearest : ', nearest)
        ...
        // console.log('C > GitributeMap > updateChoroSourceByZoom > upperRenderredFeatures : ', upperRenderredFeatures)
        ...
        for (const feat of upperRenderredFeatures) {
          // console.log("C > GitributeMap > updateChoroSourceByZoom > feat.properties : ", feat.properties )
          ...
          // console.log('C > GitributeMap > updateChoroSourceByZoom > urlBase : ', urlBase)
          const choroSource = await getData(urlBase, 'updateChoroSourceByZoom')
          // console.log('C > GitributeMap > updateChoroSourceByZoom > choroSource : ', choroSource)
    ...
    createAddGeoJsonLayers (geoJsonSourceId) {
      // console.log('\nC > GitributeMap > createAddGeoJsonLayers ... ')
      // console.log('C > GitributeMap > createAddGeoJsonLayers > this.map : ', this.map)
      // console.log('C > GitributeMap > createAddGeoJsonLayers > geoJsonSourceId : ', geoJsonSourceId)
      ...
      // console.log('C > GitributeMap > createAddGeoJsonLayers > mapLayersOptions : ', mapLayersOptions)
      // console.log('C > GitributeMap > createAddGeoJsonLayers > mapZoom : ', mapZoom)
      // console.log('C > GitributeMap > createAddGeoJsonLayers > loc : ', loc)

      const itemIdField = this.getBlockField('block_id') || 'id'
      // console.log('C > GitributeMap > createAddGeoJsonLayers > itemIdField : ', itemIdField)

      const showItemCard = this.showItemCard
      const goToDetailPage = this.goToDetailPage
      // console.log('C > GitributeMap > createAddGeoJsonLayers > showItemCard : ', showItemCard)
      // console.log('C > GitributeMap > createAddGeoJsonLayers > goToDetailPage : ', goToDetailPage)
      ...
      // console.log('C > GitributeMap > createAddGeoJsonLayers > toggleSelectedOn : ', toggleSelectedOn)
      // console.log('C > GitributeMap > createAddGeoJsonLayers > popup : ', popup)
      ...
      if (mapLayersOptions.all_points_layer && mapLayersOptions.all_points_layer.is_activated) {
        ...
        if (allPointsConfigOptions.is_clickable) {
          ...
          mapLibre.on('click', allPointsLayerId, (e) => {
            ...
            // console.log('C > GitributeMap > createGeoJsonLayers > click - all-points - featuresPoint : ', featuresPoint)
            ...
            // console.log('C > GitributeMap > createGeoJsonLayers > click - all-points - pointId : ', pointId)

            if (allPointsConfigOptions.direct_to_detail) {
              goToDetailPage(pointId)
            } else {
              const coordinates = e.features[0].geometry.coordinates.slice()
              // console.log('C > GitributeMap > createGeoJsonLayers > click - all-points - coordinates : ', coordinates)
          ...
          this.map.on('mouseenter', allPointsLayerId, (e) => {
            ...
            if (allPointsConfigOptions.has_popup) {
              ...
              // console.log('\nC > GitributeMap > createAddGeoJsonLayers > hover => featuresPolygon : ', featuresPolygon)

              // const coordinates = e.features[0].geometry.coordinates.slice()
              const itemPropsRaw = featuresPolygon[0].properties
              // console.log('C > GitributeMap > createAddGeoJsonLayers > hover => itemPropsRaw : ', itemPropsRaw)
              // remap item with fields
              const itemProps = {}
              // console.log('C > GitributeMap > createAddGeoJsonLayers > hover => fields : ', fields)
              fields.forEach(f => {
                itemProps[f.name] = itemPropsRaw[f.field]
              })
              // console.log('C > GitributeMap > createAddGeoJsonLayers > hover => itemProps : ', itemProps)
              ...
              const pop = popup
                ...
                .addTo(mapLibre)
              // console.log('C > GitributeMap > createAddGeoJsonLayers > hover => pop : ', pop)
              ...
              // console.log('C > GitributeMap > createAddGeoJsonLayers > hover => config : ', config)
              ...
              // console.log('C > GitributeMap > createAddGeoJsonLayers > hover => popInstance : ', popInstance)
      ...
      if (mapLayersOptions.cluster_circles_layer && mapLayersOptions.cluster_circles_layer.is_activated) {
        ...
        if (clusterLayerConfigOptions.is_clickable) {
          this.map.on('click', clusterLayerId, (e) => {
            ...
            // console.log('C > GitributeMap > createGeoJsonLayers > clic - clusters -  featuresSource : ', featuresSource)
            const featuresCluster = mapLibre.queryRenderedFeatures(e.point, { layers: [clusterLayerId] })
            // console.log('C > GitributeMap > createGeoJsonLayers > clic - clusters -  featuresCluster : ', featuresCluster)
            const clusterId = featuresCluster[0].properties.cluster_id
            // console.log('C > GitributeMap > createGeoJsonLayers > clic - clusters - clusterId : ', clusterId)
      ...
      if (mapLayersOptions.cluster_count_layer && mapLayersOptions.cluster_count_layer.is_activated) {
        ...
        if (countLayerConfigOptions.is_clickable) {
          this.map.on('click', countLayerId, (e) => {
            ...
            // console.log('C > GitributeMap > createGeoJsonLayers > clic - cluster-count -  featuresCluster : ', featuresCluster)
            const clusterId = featuresCluster[0].properties.cluster_id
            // console.log('C > GitributeMap > createGeoJsonLayers > clic - cluster-count - clusterId : ', clusterId)
      ...
      if (mapLayersOptions.cluster_unclustered_layer && mapLayersOptions.cluster_unclustered_layer.is_activated) {
        ...
        if (unclusteredLayerConfigOptions.is_clickable) {
          ...
          this.map.on('click', unclusteredLayerId, (e) => {
            ...
            // console.log('C > GitributeMap > createGeoJsonLayers > clic - unclustered-point - featuresPoint : ', featuresPoint)
            ...
            const pointId = itemProps[itemIdField]
            // console.log('C > GitributeMap > createGeoJsonLayers > clic - unclustered-point - pointId : ', pointId)

            if (unclusteredLayerConfigOptions.direct_to_detail) {
              goToDetailPage(pointId)
            } else {
              const coordinates = e.features[0].geometry.coordinates.slice()
              // console.log('C > GitributeMap > createGeoJsonLayers > clic - unclustered-point - coordinates : ', coordinates)
          ...
          this.map.on('mouseenter', unclusteredLayerId, (e) => {
            ...
            if (unclusteredLayerConfigOptions.has_popup) {
              ...
              // console.log('C > GitributeMap > createAddGeoJsonLayers > hover => featuresPolygon : ', featuresPolygon)

              // const coordinates = e.features[0].geometry.coordinates.slice()
              // const itemProps = featuresPolygon[0].properties
              // console.log('C > GitributeMap > createAddGeoJsonLayers > hover => coordinates : ', coordinates)
              // console.log('C > GitributeMap > createAddGeoJsonLayers > hover => itemProps : ', itemProps)
    ...
    createAddChoroplethLayers (source) {
      // console.log('\nC > GitributeMap > createAddChoroplethLayers ... ')
      // console.log('C > GitributeMap > createAddChoroplethLayers > source : ', source)
      ...
      // console.log('C > GitributeMap > createAddChoroplethLayers > choroplethConfig : ', choroplethConfig)
      ...
      if (source.has_popup) {
        ...
        this.map.on(source.popup_config.action, choroplethLayerId, (e) => {
          // console.log("C > GitributeMap > createAddChoroplethLayers > clic - choroplethLayerId - e : ", e)

          const featuresPolygon = mapLibre.queryRenderedFeatures(e.point, { layers: [choroplethLayerId] })
          // console.log("C > GitributeMap > createAddChoroplethLayers > clic - choroplethLayerId - featuresPolygon : ", featuresPolygon)

          // const coordinates = e.features[0].geometry.coordinates.slice()
          // console.log('\nC > GitributeMap > createAddChoroplethLayers > clic - choroplethLayerId - coordinates : ', coordinates)
          ...
          // }
          // console.log("C > GitributeMap > createAddChoroplethLayers > clic - choroplethLayerId - coordinates : ", coordinates)

          const itemProps = featuresPolygon[0].properties
          // console.log('C > GitributeMap > createAddChoroplethLayers > clic - choroplethLayerId - itemProps : ', itemProps)

          const pop = popup
            .setLngLat({ lng: e.lngLat.lng, lat: e.lngLat.lat })
            .setHTML('<div id="vue-popup-content"></div>')
            .addTo(mapLibre)
          // console.log('C > GitributeMap > createAddChoroplethLayers > clic - choroplethLayerId - pop : ', pop)
          // console.log("C > GitributeMap > createAddChoroplethLayers > clic - choroplethLayerId - source.popup_config : ", source.popup_config)
          ...
          // console.log('C > GitributeMap > createAddChoroplethLayers > clic - choroplethLayerId - config : ', config)
          ...
          // console.log('C > GitributeMap > createAddChoroplethLayers > clic - choroplethLayerId - popInstance : ', popInstance)
    ...
    toggleSelectedOn (event, source) {
      if (event.features.length > 0) {
        // console.log('\nC > GitributeMap > toggleSelectedOn > event.features : ', event.features)
        ...
        // console.log('C > GitributeMap > toggleSelectedOn > this.selectedStateId[ : ', this.selectedStateId)
        // console.log('C > GitributeMap > toggleSelectedOn > event.features[0] : ', event.features[0])
        ...
        // console.log('C > GitributeMap > toggleSelectedOn > itemProps : ', itemProps)
        ...
        // // console.log('C > GitributeMap > toggleSelectedOn > markerEl : ', markerEl)
    ...
    goToDetailPage (itemId) {
      console.log('C > GitributeMap > goToDetailPage > itemId : ', itemId)
    },
    ...
    getBlockField (fieldBlock) {
      // console.log('C > GitributeMap > getBlockField > fieldBlock : ', fieldBlock)
      // console.log('C > GitributeMap > getBlockField > this.contentFields : ', this.contentFields)
      // console.log('C > GitributeMap > getBlockField > this.fields : ', this.fields)
      const contentField = this.contentFields.find(f => f.position === fieldBlock)
      if (contentField) {
        // console.log('C > GitributeMap > getBlockField > contentField : ', contentField)
    ...
    showItemCard (item) {
      // console.log('C > GitributeMap > showItemCard > item : ', item)
      this.showCard = true
      this.displayedItem = item
      this.displayedItemId = item.id
      // const itemId = this.itemId(item)
      // console.log('C > GitributeMap > showItemCard > itemId : ', itemId)
    },
    ...
    toggleItemCard (event) {
      // console.log('\nC > GitributeMap > toggleItemCard > event : ', event)
    ...
    emitUpdate (event) {
      // console.log('\nC > GitributeMap > emitUpdate > event : ', event)
    ...
    joinProjectsToPolygon (source, dataLoaded, choroRefIdex, noDataProxy = false) {
      // console.log('\nC > GitributeMap > joinProjectsToPolygon ...')
      // console.log('C > GitributeMap > joinProjectsToPolygon > source : ', source)
      // console.log('C > GitributeMap > joinProjectsToPolygon > source.polygon_prop_id : ', source.polygon_prop_id)
      // console.log('C > GitributeMap > joinProjectsToPolygon > source.join_polygon_id_to_field : ', source.join_polygon_id_to_field)
      // console.log('C > GitributeMap > joinProjectsToPolygon > source.agregated_data_field : ', source.agregated_data_field)

      // console.log('C > GitributeMap > joinProjectsToPolygon > this.contentFields : ', this.contentFields)
      // console.log('C > GitributeMap > joinProjectsToPolygon > this.fields : ', this.fields)

      // modify > agregate data
      this.showLoader = true

      const dataFeatures = dataLoaded.features
      // console.log('C > GitributeMap > joinProjectsToPolygon > dataFeatures : ', dataFeatures)
      ...
      // console.log('C > GitributeMap > joinProjectsToPolygon > jointureFieldItem : ', jointureFieldItem)
      ...
      // console.log('C > GitributeMap > joinProjectsToPolygon > dataLoaded : ', dataLoaded)
