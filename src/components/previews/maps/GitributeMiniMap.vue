<template>
  <div
    class="GitributeMiniMap gitribute-component">
    <!-- DISPLAY MAP -->
    <div
      :id="mapId"
...
export default {
  ...
  watch: {
    item (next) {
      // console.log('\nC > GitributeMiniMap > watch > item > next : ', next)
  ...
  beforeMount () {
    // console.log('\nC > GitributeMiniMap > beforeMount > this.item : ', this.item)
    ...
    // console.log('C > GitributeMiniMap > beforeMount > this.item_geo_fields : ', this.item_geo_fields)
    ...
    // console.log('C > GitributeMiniMap > beforeMount > this.fieldLat : ', this.fieldLat)
    // console.log('C > GitributeMiniMap > beforeMount > this.fieldLong : ', this.fieldLong)
  ...
  methods: {
    initializeMiniMap () {
      // console.log('\nC > GitributeMiniMap > initializeMiniMap > this.item : ', this.item)
      // console.log('C > GitributeMiniMap > initializeMiniMap > this.item.id : ', this.item.id)
      // console.log('C > GitributeMiniMap > initializeMiniMap > this.item[2] : ', this.item[2])
      ...
      // console.log('C > GitributeMiniMap > initializeMiniMap > map : ', map)
      map.on('load', async () => {
        ...
        //   </i>
        // </span>`
        //         console.log('C > GitributeMiniMap > initializeMiniMap > markerEl : ', markerEl)
